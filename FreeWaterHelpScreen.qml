...
Rectangle{
    ...
    FreeWaterHelpScreenForm {
        ...
        btnInvite.onButtonClick: {
            var url = ""
            var message = "Отримай бутиль води безкоштовно від служби доставки води \“Хвиля Здоров’я\”!
Використай промо-код: "+promoCodeText.text +" при реєстрації в мобільному додатку. Деталі: http://hz-app.com.ua/"
///'\n Закачуй и встановлюй\n:
//" + androidlink +"\n\n"+ioslink
